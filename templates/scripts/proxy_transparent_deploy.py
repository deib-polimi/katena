...
parser.add_argument('--implementationParameters', nargs='*', help='proxy implementation parameters to save in proxy storage')
...
PROXY_BYTECODE = proxy_json['bytecode']
...
params = args.implementationParameters
