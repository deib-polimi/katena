...
export interface UUPSImplementation1Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "add"
      | "count"
...
export interface UUPSImplementation1 extends BaseContract {
  connect(runner?: ContractRunner | null): UUPSImplementation1;
  waitForDeployment(): Promise<this>;

  interface: UUPSImplementation1Interface;
