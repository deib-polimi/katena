...
export interface HookERC721VaultImplV1Interface extends Interface {
  getFunction(
    nameOrSignature:
  ...
  encodeFunctionData(
    functionFragment: "hasActiveEntitlement",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "initialize(address,uint256,address)",
  ...
  encodeFunctionData(
    functionFragment: "validateEntitlementSignature",
    values: [
      AddressLike,
      BigNumberish,
      BigNumberish,
...
export interface HookERC721VaultImplV1 extends BaseContract {
  connect(runner?: ContractRunner | null): HookERC721VaultImplV1;
  waitForDeployment(): Promise<this>;

  interface: HookERC721VaultImplV1Interface;
  ...
  assetAddress: TypedContractMethod<[arg0: BigNumberish], [string], "view">;
  ...
  hasActiveEntitlement: TypedContractMethod<
    [assetId: BigNumberish],
    [boolean],
    "view"
  >;
  ...
  "initialize(address,address)": TypedContractMethod<
    [nftContract: AddressLike, hookAddress: AddressLike],
    [void],
    "nonpayable"
  >;

  "initialize(address,uint256,address)": TypedContractMethod<
    [nftContract: AddressLike, tokenId: BigNumberish, hookAddress: AddressLike],
    [void],
    "nonpayable"
  >;
  ...
  validateEntitlementSignature: TypedContractMethod<
    [
      operator: AddressLike,
      expiry: BigNumberish,
      assetId: BigNumberish,
  ...
  >;
  getFunction(
    nameOrSignature: "hasActiveEntitlement"
  ): TypedContractMethod<[assetId: BigNumberish], [boolean], "view">;
  getFunction(
  ...
  >;
  getFunction(
    nameOrSignature: "initialize(address,uint256,address)"
  ): TypedContractMethod<
    [nftContract: AddressLike, tokenId: BigNumberish, hookAddress: AddressLike],
    [void],
    "nonpayable"
  ...
  getFunction(
    nameOrSignature: "validateEntitlementSignature"
  ): TypedContractMethod<
    [
      operator: AddressLike,
      expiry: BigNumberish,
