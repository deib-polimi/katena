...
export interface HookERC721MultiVaultImplV1Interface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface HookERC721MultiVaultImplV1 extends BaseContract {
  connect(runner?: ContractRunner | null): HookERC721MultiVaultImplV1;
  waitForDeployment(): Promise<this>;

  interface: HookERC721MultiVaultImplV1Interface;
