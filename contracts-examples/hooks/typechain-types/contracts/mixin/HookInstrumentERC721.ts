...
export interface HookInstrumentERC721Interface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface HookInstrumentERC721 extends BaseContract {
  connect(runner?: ContractRunner | null): HookInstrumentERC721;
  waitForDeployment(): Promise<this>;

  interface: HookInstrumentERC721Interface;
