...
export interface IHookVaultInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "approveOperator"
      | "assetAddress"
...
export interface IHookVault extends BaseContract {
  connect(runner?: ContractRunner | null): IHookVault;
  waitForDeployment(): Promise<this>;

  interface: IHookVaultInterface;
