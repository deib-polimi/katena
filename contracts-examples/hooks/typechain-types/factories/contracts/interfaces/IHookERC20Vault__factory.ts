...
import type {
  IHookERC20Vault,
  IHookERC20VaultInterface,
} from "../../../contracts/interfaces/IHookERC20Vault";
...
export class IHookERC20Vault__factory {
  static readonly abi = _abi;
  static createInterface(): IHookERC20VaultInterface {
    return new Interface(_abi) as IHookERC20VaultInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): IHookERC20Vault {
    return new Contract(address, _abi, runner) as unknown as IHookERC20Vault;
  }
}
